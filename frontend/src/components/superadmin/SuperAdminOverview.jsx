...
export default function SuperAdminOverview({ metrics, loading }) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white text-slate-900 p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <button
                        ...
                        className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-xs transition-all flex items-center gap-2 text-xs sm:text-sm cursor-pointer"
                    >
                        <FiPlusCircle className="w-4 h-4" /> Nueva Empresa
                    </button>
                    <button
                        onClick={() => navigate('/superadmin/tenants')}
                        className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-xl border border-slate-200 transition-all flex items-center gap-2 text-xs sm:text-sm cursor-pointer"
                    >
