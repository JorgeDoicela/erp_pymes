    ...
    if (loading && !metrics) {
        return (
            <div className="p-12 text-center text-gray-400 text-xs font-mono">
                Cargando centro de calibración y certeza...
            </div>
        );
    }
            ...
            <div className="pb-4 border-b border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-xl font-semibold text-gray-900">
                        Calibración RSI (Robust Stability Index) & Certeza
                    </h1>
                    <p className="text-sm text-gray-500 mt-0.5">
                        Ajusta y afina automáticamente la objetividad de las calificaciones de desempeño y las proyecciones de permanencia.
                    </p>
                </div>
