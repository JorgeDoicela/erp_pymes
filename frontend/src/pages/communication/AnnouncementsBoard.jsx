        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                {isAdmin && (
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded shadow-md transition-all text-sm"
                    >
                ...
                <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0">
                    ...
                    {[
                        ...
                        <button
                            ...
                            className={`px-3.5 py-1.5 rounded text-xs font-bold transition-all whitespace-nowrap ${filterCategory === tab.value
                ...
                <form onSubmit={handleSearch} className="flex gap-2 w-full md:w-72">
                    <div className="relative w-full">
                        ...
                        <input
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded pl-9 pr-4 py-2 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                            value={searchTerm}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-5">
                    {loading ? (
                        <div className="bg-white p-12 text-center text-slate-400 rounded border">Cargando comunicados...</div>
                    ) : announcements.length === 0 ? (
                        <div className="bg-white p-12 text-center text-slate-400 rounded border">No se encontraron comunicados publicados.</div>
                    ) : (
                        announcements.map(ann => (
                            <motion.div
                                ...
                                className={`bg-white p-6 rounded border shadow-sm space-y-4 ${ann.priority === 'URGENT' ? 'border-rose-300 ring-1 ring-rose-300' : 'border-slate-200/80'
                                    }`}
                            >
                                ...
                                {ann.attachmentUrl && (
                                    <div className="pt-2">
                                        <a
                                            ...
                                            className="inline-flex items-center gap-1.5 text-xs font-bold text-blue-600 hover:underline bg-blue-50 px-3 py-2 rounded border border-blue-200"
                                        >
                                ...
                                {ann.requiresAcknowledgment && (
                                    <div className="pt-3 border-t border-slate-100">
                                        {ann.isAcknowledged ? (
                                            ...
                                            <div className="bg-amber-50/80 border border-amber-300 p-4 rounded space-y-3">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-extrabold text-xs rounded shadow-sm transition-all flex items-center justify-center gap-2"
                                                >
                    ...
                    <div className="bg-white p-6 rounded border border-slate-200 shadow-xs space-y-4">
                        ...
                        <div className="space-y-2 pt-1">
                            {birthdays.length === 0 ? (
                                ...
                                birthdays.map(bday => (
                                    <div key={bday.id} className="p-3 bg-slate-50 rounded flex items-center justify-between border border-slate-100 text-xs">
                                        <div>
                            ...
                            <form onSubmit={handlePublishSubmit} className="p-6 space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 rounded p-3 text-xs text-slate-800 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none font-bold"
                                        value={form.title}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select
                                            className="w-full bg-slate-50 border border-slate-200 rounded p-3 text-xs text-slate-800 outline-none"
                                            value={form.category}
                                ...
                                <div>
                                    ...
                                    <input
                                        type="url"
                                        placeholder="https://..."
                                        className="w-full bg-slate-50 border border-slate-200 rounded p-3 text-xs text-slate-800 outline-none font-mono"
                                        value={form.attachmentUrl}
                                        onChange={(e) => setForm({ ...form, attachmentUrl: e.target.value })}
                                    />
                                </div>

                                <div className="p-3.5 bg-amber-50 rounded border border-amber-200 flex items-center gap-3">
                                    <input
                                        type="checkbox"
                                        id="reqAck"
                                ...
                                <div className="flex justify-end gap-3 pt-2">
                                    ...
                                    <button type="submit" disabled={actionLoading} className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded shadow-md">
