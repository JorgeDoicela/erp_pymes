...
router.get('/profile/me', authenticate, employeeController.getProfile);
...
router.put('/:id', authenticate, authorize(['admin', 'hr', 'employee']), validateEmployeeData, employeeController.update);
